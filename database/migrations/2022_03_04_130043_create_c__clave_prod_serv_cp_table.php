...
class CreateCClaveProdServCpTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_ClaveProdServCP', function (Blueprint $table) {
            $table->bigIncrements('Numero');
            $table->string('Clave', 20)->nullable();
            $table->string('Descripcion', 255)->nullable();
            $table->text('PalabrasSimilares')->nullable();
    ...
    {
        Schema::dropIfExists('c_ClaveProdServCP');
    }
}
