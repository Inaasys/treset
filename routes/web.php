...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/folios_comprobantes_facturas_enviar_archivos_timbrado', 'FolioComprobanteFacturaController@folios_comprobantes_facturas_enviar_archivos_timbrado')->name('folios_comprobantes_facturas_enviar_archivos_timbrado')->middleware('revisarpermisos:catalogos.folios.fiscales.folios.facturas.altas');
    ...
    Route::post('/folios_comprobantes_notas_enviar_archivos_timbrado', 'FolioComprobanteNotaController@folios_comprobantes_notas_enviar_archivos_timbrado')->name('folios_comprobantes_notas_enviar_archivos_timbrado')->middleware('revisarpermisos:catalogos.folios.fiscales.folios.notas.altas');
    ...
    Route::post('/folios_comprobantes_pagos_enviar_archivos_timbrado', 'FolioComprobantePagoController@folios_comprobantes_pagos_enviar_archivos_timbrado')->name('folios_comprobantes_pagos_enviar_archivos_timbrado')->middleware('revisarpermisos:catalogos.folios.fiscales.folios.pagos.altas');
    ...
    Route::get('/ordenes_compra_generar_plantilla', 'OrdenCompraController@ordenes_compra_generar_plantilla')->name('ordenes_compra_generar_plantilla')->middleware('revisaraccesomenu:menuregistrosordenescompra');
    Route::post('/ordenes_compra_cargar_partidas_excel', 'OrdenCompraController@ordenes_compra_cargar_partidas_excel')->name('ordenes_compra_cargar_partidas_excel')->middleware('revisaraccesomenu:menuregistrosordenescompra');
    ...
    Route::get('/ordenes_compra_obtener_producto_por_codigo', 'OrdenCompraController@ordenes_compra_obtener_producto_por_codigo')->name('ordenes_compra_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistrosordenescompra');
    ...
    Route::get('/ordenes_compra_verificar_autorizacion', 'OrdenCompraController@ordenes_compra_verificar_autorizacion')->name('ordenes_compra_verificar_autorizacion')->middleware('revisaraccesomenu:menuregistrosordenescompra');
    ...
    Route::get('/ordenes_compra_verificar_quitar_autorizacion', 'OrdenCompraController@ordenes_compra_verificar_quitar_autorizacion')->name('ordenes_compra_verificar_quitar_autorizacion')->middleware('revisaraccesomenu:menuregistrosordenescompra');
    Route::post('/ordenes_compra_quitar_autorizacion', 'OrdenCompraController@ordenes_compra_quitar_autorizacion')->name('ordenes_compra_quitar_autorizacion')->middleware('revisarpermisos:registros.ordenescompra.autorizar');
    ...
    Route::get('/compras_obtener_producto_por_codigo', 'CompraController@compras_obtener_producto_por_codigo')->name('compras_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistroscompras');
    ...
    Route::get('/ordenes_trabajo_obtener_cotizaciones', 'OrdenTrabajoController@ordenes_trabajo_obtener_cotizaciones')->name('ordenes_trabajo_obtener_cotizaciones')->middleware('revisaraccesomenu:menuregistrosordenestrabajo');
    Route::get('/ordenes_trabajo_obtener_cotizacion', 'OrdenTrabajoController@ordenes_trabajo_obtener_cotizacion')->name('ordenes_trabajo_obtener_cotizacion')->middleware('revisaraccesomenu:menuregistrosordenestrabajo');
    ...
    Route::get('/ordenes_trabajo_obtener_servicio_por_codigo', 'OrdenTrabajoController@ordenes_trabajo_obtener_servicio_por_codigo')->name('ordenes_trabajo_obtener_servicio_por_codigo')->middleware('revisaraccesomenu:menuregistrosordenestrabajo');
    ...
    Route::get('/notas_credito_proveedores_obtener_producto_por_codigo', 'NotasCreditoProveedoresController@notas_credito_proveedores_obtener_producto_por_codigo')->name('notas_credito_proveedores_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistrosnotascreditoproveedores');
    ...
    Route::get('/notas_credito_clientes_obtener_producto_por_codigo', 'NotasCreditoClientesController@notas_credito_clientes_obtener_producto_por_codigo')->name('notas_credito_clientes_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistrosnotascreditoclientes');
    ...
    Route::get('/asignacion_herramienta_obtener_herramienta_por_codigo', 'AsignacionHerramientaController@asignacion_herramienta_obtener_herramienta_por_codigo')->name('asignacion_herramienta_obtener_herramienta_por_codigo')->middleware('revisaraccesomenu:menuregistrosasignacionherramienta');
    ...
    Route::get('/cotizaciones_productos_obtener_series_documento', 'CotizacionProductoController@cotizaciones_productos_obtener_series_documento')->name('cotizaciones_productos_obtener_series_documento')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_ultimo_folio_serie_seleccionada', 'CotizacionProductoController@cotizaciones_productos_obtener_ultimo_folio_serie_seleccionada')->name('cotizaciones_productos_obtener_ultimo_folio_serie_seleccionada')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_ultimo_folio', 'CotizacionProductoController@cotizaciones_productos_obtener_ultimo_folio')->name('cotizaciones_productos_obtener_ultimo_folio')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_fecha_actual_datetimelocal', 'CotizacionProductoController@cotizaciones_productos_obtener_fecha_actual_datetimelocal')->name('cotizaciones_productos_obtener_fecha_actual_datetimelocal')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_tipos_ordenes_compra', 'CotizacionProductoController@cotizaciones_productos_obtener_tipos_ordenes_compra')->name('cotizaciones_productos_obtener_tipos_ordenes_compra')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_clientes', 'CotizacionProductoController@cotizaciones_productos_obtener_clientes')->name('cotizaciones_productos_obtener_clientes')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_agentes', 'CotizacionProductoController@cotizaciones_productos_obtener_agentes')->name('cotizaciones_productos_obtener_agentes')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_cliente_por_numero', 'CotizacionProductoController@cotizaciones_productos_obtener_cliente_por_numero')->name('cotizaciones_productos_obtener_cliente_por_numero')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_agente_por_numero', 'CotizacionProductoController@cotizaciones_productos_obtener_agente_por_numero')->name('cotizaciones_productos_obtener_agente_por_numero')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_productos', 'CotizacionProductoController@cotizaciones_productos_obtener_productos')->name('cotizaciones_productos_obtener_productos')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_producto_por_codigo', 'CotizacionProductoController@cotizaciones_productos_obtener_producto_por_codigo')->name('cotizaciones_productos_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_existencias_almacen_uno', 'CotizacionProductoController@cotizaciones_productos_obtener_existencias_almacen_uno')->name('cotizaciones_productos_obtener_existencias_almacen_uno')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_nuevo_saldo_cliente', 'CotizacionProductoController@cotizaciones_productos_obtener_nuevo_saldo_cliente')->name('cotizaciones_productos_obtener_nuevo_saldo_cliente')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::post('/cotizaciones_productos_guardar', 'CotizacionProductoController@cotizaciones_productos_guardar')->name('cotizaciones_productos_guardar')->middleware('revisarpermisos:registros.cotizaciones.productos.altas');
    Route::get('/cotizaciones_productos_verificar_baja', 'CotizacionProductoController@cotizaciones_productos_verificar_baja')->name('cotizaciones_productos_verificar_baja')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::post('/cotizaciones_productos_bajas', 'CotizacionProductoController@cotizaciones_productos_bajas')->name('cotizaciones_productos_bajas')->middleware('revisarpermisos:registros.cotizaciones.productos.bajas');
    Route::get('/cotizaciones_productos_obtener_cotizacion_producto', 'CotizacionProductoController@cotizaciones_productos_obtener_cotizacion_producto')->name('cotizaciones_productos_obtener_cotizacion_producto')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::post('/cotizaciones_productos_guardar_modificacion', 'CotizacionProductoController@cotizaciones_productos_guardar_modificacion')->name('cotizaciones_productos_guardar_modificacion')->middleware('revisarpermisos:registros.cotizaciones.productos.cambios');
    Route::get('/cotizaciones_productos_buscar_folio_string_like', 'CotizacionProductoController@cotizaciones_productos_buscar_folio_string_like')->name('cotizaciones_productos_buscar_folio_string_like')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::post('/cotizaciones_productos_generar_pdfs', 'CotizacionProductoController@cotizaciones_productos_generar_pdfs')->name('cotizaciones_productos_generar_pdfs')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_generar_pdfs_indiv/{documento}', 'CotizacionProductoController@cotizaciones_productos_generar_pdfs_indiv')->name('cotizaciones_productos_generar_pdfs_indiv')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_obtener_datos_envio_email', 'CotizacionProductoController@cotizaciones_productos_obtener_datos_envio_email')->name('cotizaciones_productos_obtener_datos_envio_email')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::post('/cotizaciones_productos_enviar_pdfs_email', 'CotizacionProductoController@cotizaciones_productos_enviar_pdfs_email')->name('cotizaciones_productos_enviar_pdfs_email')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_generar_pdfs_cliente_indiv/{documento}', 'CotizacionProductoController@cotizaciones_productos_generar_pdfs_cliente_indiv')->name('cotizaciones_productos_generar_pdfs_cliente_indiv')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::post('/cotizaciones_productos_enviar_pdfs_cliente_email', 'CotizacionProductoController@cotizaciones_productos_enviar_pdfs_cliente_email')->name('cotizaciones_productos_enviar_pdfs_cliente_email')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::get('/cotizaciones_productos_exportar_excel', 'CotizacionProductoController@cotizaciones_productos_exportar_excel')->name('cotizaciones_productos_exportar_excel')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    Route::post('/cotizaciones_productos_guardar_configuracion_tabla', 'CotizacionProductoController@cotizaciones_productos_guardar_configuracion_tabla')->name('cotizaciones_productos_guardar_configuracion_tabla')->middleware('revisaraccesomenu:menuregistroscotizacionesproductos');
    //Cotizaciones Servicios
    Route::get('/cotizaciones_servicios', 'CotizacionServicioController@cotizaciones_servicios')->name('cotizaciones_servicios')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener', 'CotizacionServicioController@cotizaciones_servicios_obtener')->name('cotizaciones_servicios_obtener')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_series_documento', 'CotizacionServicioController@cotizaciones_servicios_obtener_series_documento')->name('cotizaciones_servicios_obtener_series_documento')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_ultimo_folio_serie_seleccionada', 'CotizacionServicioController@cotizaciones_servicios_obtener_ultimo_folio_serie_seleccionada')->name('cotizaciones_servicios_obtener_ultimo_folio_serie_seleccionada')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_ultimo_folio', 'CotizacionServicioController@cotizaciones_servicios_obtener_ultimo_folio')->name('cotizaciones_servicios_obtener_ultimo_folio')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_fecha_actual_datetimelocal', 'CotizacionServicioController@cotizaciones_servicios_obtener_fecha_actual_datetimelocal')->name('cotizaciones_servicios_obtener_fecha_actual_datetimelocal')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_tipos_unidades', 'CotizacionServicioController@cotizaciones_servicios_obtener_tipos_unidades')->name('cotizaciones_servicios_obtener_tipos_unidades')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_clientes', 'CotizacionServicioController@cotizaciones_servicios_obtener_clientes')->name('cotizaciones_servicios_obtener_clientes')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_agentes', 'CotizacionServicioController@cotizaciones_servicios_obtener_agentes')->name('cotizaciones_servicios_obtener_agentes')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_cliente_por_numero', 'CotizacionServicioController@cotizaciones_servicios_obtener_cliente_por_numero')->name('cotizaciones_servicios_obtener_cliente_por_numero')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_agente_por_numero', 'CotizacionServicioController@cotizaciones_servicios_obtener_agente_por_numero')->name('cotizaciones_servicios_obtener_agente_por_numero')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_vines', 'CotizacionServicioController@cotizaciones_servicios_obtener_vines')->name('cotizaciones_servicios_obtener_vines')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_vin_por_numero', 'CotizacionServicioController@cotizaciones_servicios_obtener_vin_por_numero')->name('cotizaciones_servicios_obtener_vin_por_numero')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_productos', 'CotizacionServicioController@cotizaciones_servicios_obtener_productos')->name('cotizaciones_servicios_obtener_productos')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_producto_por_codigo', 'CotizacionServicioController@cotizaciones_servicios_obtener_producto_por_codigo')->name('cotizaciones_servicios_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_existencias_almacen_uno', 'CotizacionServicioController@cotizaciones_servicios_obtener_existencias_almacen_uno')->name('cotizaciones_servicios_obtener_existencias_almacen_uno')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_servicios', 'CotizacionServicioController@cotizaciones_servicios_obtener_servicios')->name('cotizaciones_servicios_obtener_servicios')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_servicio_por_codigo', 'CotizacionServicioController@cotizaciones_servicios_obtener_servicio_por_codigo')->name('cotizaciones_servicios_obtener_servicio_por_codigo')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::post('/cotizaciones_servicios_guardar', 'CotizacionServicioController@cotizaciones_servicios_guardar')->name('cotizaciones_servicios_guardar')->middleware('revisarpermisos:registros.cotizaciones.servicios.altas');
    Route::get('/cotizaciones_servicios_verificar_baja', 'CotizacionServicioController@cotizaciones_servicios_verificar_baja')->name('cotizaciones_servicios_verificar_baja')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::post('/cotizaciones_servicios_bajas', 'CotizacionServicioController@cotizaciones_servicios_bajas')->name('cotizaciones_servicios_bajas')->middleware('revisarpermisos:registros.cotizaciones.servicios.bajas');
    Route::get('/cotizaciones_servicios_obtener_cotizacion_servicio', 'CotizacionServicioController@cotizaciones_servicios_obtener_cotizacion_servicio')->name('cotizaciones_servicios_obtener_cotizacion_servicio')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::post('/cotizaciones_servicios_guardar_modificacion', 'CotizacionServicioController@cotizaciones_servicios_guardar_modificacion')->name('cotizaciones_servicios_guardar_modificacion')->middleware('revisarpermisos:registros.cotizaciones.servicios.cambios');
    Route::get('/cotizaciones_servicios_buscar_folio_string_like', 'CotizacionServicioController@cotizaciones_servicios_buscar_folio_string_like')->name('cotizaciones_servicios_buscar_folio_string_like')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::post('/cotizaciones_servicios_generar_pdfs', 'CotizacionServicioController@cotizaciones_servicios_generar_pdfs')->name('cotizaciones_servicios_generar_pdfs')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_generar_pdfs_indiv/{documento}', 'CotizacionServicioController@cotizaciones_servicios_generar_pdfs_indiv')->name('cotizaciones_servicios_generar_pdfs_indiv')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_obtener_datos_envio_email', 'CotizacionServicioController@cotizaciones_servicios_obtener_datos_envio_email')->name('cotizaciones_servicios_obtener_datos_envio_email')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::post('/cotizaciones_servicios_enviar_pdfs_email', 'CotizacionServicioController@cotizaciones_servicios_enviar_pdfs_email')->name('cotizaciones_servicios_enviar_pdfs_email')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_generar_pdfs_cliente_indiv/{documento}', 'CotizacionServicioController@cotizaciones_servicios_generar_pdfs_cliente_indiv')->name('cotizaciones_servicios_generar_pdfs_cliente_indiv')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::post('/cotizaciones_servicios_enviar_pdfs_cliente_email', 'CotizacionServicioController@cotizaciones_servicios_enviar_pdfs_cliente_email')->name('cotizaciones_servicios_enviar_pdfs_cliente_email')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::get('/cotizaciones_servicios_exportar_excel', 'CotizacionServicioController@cotizaciones_servicios_exportar_excel')->name('cotizaciones_servicios_exportar_excel')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    Route::post('/cotizaciones_servicios_guardar_configuracion_tabla', 'CotizacionServicioController@cotizaciones_servicios_guardar_configuracion_tabla')->name('cotizaciones_servicios_guardar_configuracion_tabla')->middleware('revisaraccesomenu:menuregistroscotizacionesservicios');
    //Ajuste Inventario
    ...
    Route::get('/ajustesinventario_obtener_producto_por_codigo', 'AjusteInventarioController@ajustesinventario_obtener_producto_por_codigo')->name('ajustesinventario_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistrosajusteinventario');
    ...
    Route::get('/traspasos_obtener_cotizaciones', 'TraspasoController@traspasos_obtener_cotizaciones')->name('traspasos_obtener_cotizaciones')->middleware('revisaraccesomenu:menuregistrostraspasos');
    Route::get('/traspasos_obtener_cotizacion', 'TraspasoController@traspasos_obtener_cotizacion')->name('traspasos_obtener_cotizacion')->middleware('revisaraccesomenu:menuregistrostraspasos');    
    Route::get('/traspasos_obtener_requisiciones', 'TraspasoController@traspasos_obtener_requisiciones')->name('traspasos_obtener_requisiciones')->middleware('revisaraccesomenu:menuregistrostraspasos');
    Route::get('/traspasos_obtener_requisicion', 'TraspasoController@traspasos_obtener_requisicion')->name('traspasos_obtener_requisicion')->middleware('revisaraccesomenu:menuregistrostraspasos');
    ...
    Route::get('/traspasos_obtener_producto_por_codigo', 'TraspasoController@traspasos_obtener_producto_por_codigo')->name('traspasos_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistrostraspasos');
    ...
    Route::get('/remisiones_generar_plantilla', 'RemisionController@remisiones_generar_plantilla')->name('remisiones_generar_plantilla')->middleware('revisaraccesomenu:menuregistrosremisiones');
    Route::post('/remisiones_cargar_partidas_excel', 'RemisionController@remisiones_cargar_partidas_excel')->name('remisiones_cargar_partidas_excel')->middleware('revisaraccesomenu:menuregistrosremisiones');
    ...
    Route::get('/facturas_obtener_kardex', 'FacturaController@facturas_obtener_kardex')->name('facturas_obtener_kardex')->middleware('revisaraccesomenu:menuregistrosfacturas');
    ...
    Route::post('/facturas_enviar_pdfs_clientes_email', 'FacturaController@facturas_enviar_pdfs_clientes_email')->name('facturas_enviar_pdfs_clientes_email')->middleware('revisaraccesomenu:menuregistrosfacturas');
    ...
    Route::get('/facturas_generar_pdfs_cliente_indiv/{documento}', 'FacturaController@facturas_generar_pdfs_cliente_indiv')->name('facturas_generar_pdfs_cliente_indiv')->middleware('revisaraccesomenu:menuregistrosfacturas');
    ...
    Route::get('/produccion_obtener_series_documento', 'ProduccionController@produccion_obtener_series_documento')->name('produccion_obtener_series_documento')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_ultimo_folio_serie_seleccionada', 'ProduccionController@produccion_obtener_ultimo_folio_serie_seleccionada')->name('produccion_obtener_ultimo_folio_serie_seleccionada')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_ultimo_folio', 'ProduccionController@produccion_obtener_ultimo_folio')->name('produccion_obtener_ultimo_folio')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_clientes', 'ProduccionController@produccion_obtener_clientes')->name('produccion_obtener_clientes')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_cliente_por_numero', 'ProduccionController@produccion_obtener_cliente_por_numero')->name('produccion_obtener_cliente_por_numero')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_almacen_por_numero', 'ProduccionController@produccion_obtener_almacen_por_numero')->name('produccion_obtener_almacen_por_numero')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_almacenes', 'ProduccionController@produccion_obtener_almacenes')->name('produccion_obtener_almacenes')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_productos', 'ProduccionController@produccion_obtener_productos')->name('produccion_obtener_productos')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_producto_por_codigo', 'ProduccionController@produccion_obtener_producto_por_codigo')->name('produccion_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_productos_insumos_pt', 'ProduccionController@produccion_obtener_productos_insumos_pt')->name('produccion_obtener_productos_insumos_pt')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_producto_insumo_pt_por_codigo', 'ProduccionController@produccion_obtener_producto_insumo_pt_por_codigo')->name('produccion_obtener_producto_insumo_pt_por_codigo')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_existencias_almacen', 'ProduccionController@produccion_obtener_existencias_almacen')->name('produccion_obtener_existencias_almacen')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::post('/produccion_guardar', 'ProduccionController@produccion_guardar')->name('produccion_guardar')->middleware('revisarpermisos:registros.produccion.altas');
    Route::get('/produccion_verificar_existencias_insumos_produccion', 'ProduccionController@produccion_verificar_existencias_insumos_produccion')->name('produccion_verificar_existencias_insumos_produccion')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::post('/produccion_realizar_produccion', 'ProduccionController@produccion_realizar_produccion')->name('produccion_realizar_produccion')->middleware('revisarpermisos:registros.produccion.altas');
    Route::get('/produccion_verificar_baja', 'ProduccionController@produccion_verificar_baja')->name('produccion_verificar_baja')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::post('/produccion_alta_o_baja', 'ProduccionController@produccion_alta_o_baja')->name('produccion_alta_o_baja')->middleware('revisarpermisos:registros.produccion.bajas');
    Route::get('/produccion_obtener_produccion', 'ProduccionController@produccion_obtener_produccion')->name('produccion_obtener_produccion')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::post('/produccion_guardar_modificacion', 'ProduccionController@produccion_guardar_modificacion')->name('produccion_guardar_modificacion')->middleware('revisarpermisos:registros.produccion.cambios');
    Route::get('/produccion_buscar_folio_string_like', 'ProduccionController@produccion_buscar_folio_string_like')->name('produccion_buscar_folio_string_like')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::post('/produccion_generar_pdfs', 'ProduccionController@produccion_generar_pdfs')->name('produccion_generar_pdfs')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_obtener_datos_envio_email', 'ProduccionController@produccion_obtener_datos_envio_email')->name('produccion_obtener_datos_envio_email')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::post('/produccion_enviar_pdfs_email', 'ProduccionController@produccion_enviar_pdfs_email')->name('produccion_enviar_pdfs_email')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_generar_pdfs_indiv/{documento}', 'ProduccionController@produccion_generar_pdfs_indiv')->name('produccion_generar_pdfs_indiv')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::get('/produccion_exportar_excel', 'ProduccionController@produccion_exportar_excel')->name('produccion_exportar_excel')->middleware('revisaraccesomenu:menuregistrosproduccion');
    Route::post('/produccion_guardar_configuracion_tabla', 'ProduccionController@produccion_guardar_configuracion_tabla')->name('produccion_guardar_configuracion_tabla')->middleware('revisaraccesomenu:menuregistrosproduccion');
    //Requisiciones
    Route::get('/requisiciones', 'RequisicionController@requisiciones')->name('requisiciones')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::get('/requisiciones_obtener', 'RequisicionController@requisiciones_obtener')->name('requisiciones_obtener')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::get('/requisiciones_obtener_series_documento', 'RequisicionController@requisiciones_obtener_series_documento')->name('requisiciones_obtener_series_documento')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::get('/requisiciones_obtener_ultimo_folio_serie_seleccionada', 'RequisicionController@requisiciones_obtener_ultimo_folio_serie_seleccionada')->name('requisiciones_obtener_ultimo_folio_serie_seleccionada')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::get('/requisiciones_obtener_ultimo_folio', 'RequisicionController@requisiciones_obtener_ultimo_folio')->name('requisiciones_obtener_ultimo_folio')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::get('/requisiciones_obtener_ordenes_trabajo', 'RequisicionController@requisiciones_obtener_ordenes_trabajo')->name('requisiciones_obtener_ordenes_trabajo')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::get('/requisiciones_obtener_orden_trabajo_por_folio', 'RequisicionController@requisiciones_obtener_orden_trabajo_por_folio')->name('requisiciones_obtener_orden_trabajo_por_folio')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::get('/requisiciones_obtener_productos', 'RequisicionController@requisiciones_obtener_productos')->name('requisiciones_obtener_productos')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::get('/requisiciones_obtener_producto_por_codigo', 'RequisicionController@requisiciones_obtener_producto_por_codigo')->name('requisiciones_obtener_producto_por_codigo')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::post('/requisiciones_guardar', 'RequisicionController@requisiciones_guardar')->name('requisiciones_guardar')->middleware('revisarpermisos:registros.requisiciones.altas');
    Route::get('/requisiciones_verificar_baja', 'RequisicionController@requisiciones_verificar_baja')->name('requisiciones_verificar_baja')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::post('/requisiciones_alta_o_baja', 'RequisicionController@requisiciones_alta_o_baja')->name('requisiciones_alta_o_baja')->middleware('revisarpermisos:registros.requisiciones.bajas');
    Route::get('/requisiciones_obtener_requisicion', 'RequisicionController@requisiciones_obtener_requisicion')->name('requisiciones_obtener_requisicion')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::post('/requisiciones_guardar_modificacion', 'RequisicionController@requisiciones_guardar_modificacion')->name('requisiciones_guardar_modificacion')->middleware('revisarpermisos:registros.requisiciones.cambios');
    Route::get('/requisiciones_buscar_folio_string_like', 'RequisicionController@requisiciones_buscar_folio_string_like')->name('requisiciones_buscar_folio_string_like')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::post('/requisiciones_generar_pdfs', 'RequisicionController@requisiciones_generar_pdfs')->name('requisiciones_generar_pdfs')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::get('/requisiciones_obtener_datos_envio_email', 'RequisicionController@requisiciones_obtener_datos_envio_email')->name('requisiciones_obtener_datos_envio_email')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    Route::post('/requisiciones_enviar_pdfs_email', 'RequisicionController@requisiciones_enviar_pdfs_email')->name('requisiciones_enviar_pdfs_email')->middleware('revisaraccesomenu:menuregistrosrequisiciones');
    ...
    Route::post('/empresa_guardar_registro_empresa_facturapi', 'EmpresaController@empresa_guardar_registro_empresa_facturapi')->name('empresa_guardar_registro_empresa_facturapi');
    /* -----------------------------------||||||||||||||||||||FIN EMPRESA||||||||||||||||||||||-------------------------------------*/
