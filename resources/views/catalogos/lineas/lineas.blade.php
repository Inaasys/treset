                                    ...
                                    <div class="table-responsive navbar-right">
                                        <table>
                                            <tr>
                                                ...
                                                <td >
                                                    <a class="btn bg-blue btn-xs waves-effect" href="{{route('lineas_exportar_excel')}}" target="_blank">
                                                        Excel
                                                    </a>
                                                </td>
                                            </tr>
    	...
    	<div class="modal-content">
      		...
      		<div class="modal-body">
		      	<form id="formdesactivar" action="#">
		        	...
		        	<input type="hidden" id="numerolinea" name="numerolinea">
		        </form>	
      		</div>
	      	<div class="modal-footer">
...
@section('additionals_js')
    <script>
        ...
        var lineas_obtener = '{!!URL::to('lineas_obtener')!!}';
        var lineas_obtener_ultimo_numero = '{!!URL::to('lineas_obtener_ultimo_numero')!!}';
        var lineas_guardar = '{!!URL::to('lineas_guardar')!!}';
        var lineas_alta_o_baja = '{!!URL::to('lineas_alta_o_baja')!!}'; 
        var lineas_obtener_linea = '{!!URL::to('lineas_obtener_linea')!!}'; 
        var lineas_guardar_modificacion = '{!!URL::to('lineas_guardar_modificacion')!!}';
    </script>
    @include('secciones.libreriasregistrosycatalogos')
    <script src="scripts_inaasys/catalogos/lineas/lineas.js"></script>
@endsection