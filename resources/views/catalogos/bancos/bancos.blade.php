                                    ...
                                    <div class="table-responsive navbar-right">
                                        <table>
                                            <tr>
                                                ...
                                                <td >
                                                    <a class="btn bg-blue btn-xs waves-effect" href="{{route('bancos_exportar_excel')}}" target="_blank">
                                                        Excel
                                                    </a>
                                                </td>
                                            </tr>
    	...
    	<div class="modal-content">
      		...
      		<div class="modal-body">
		      	<form id="formdesactivar" action="#">
		        	...
		        	<input type="hidden" id="numerobanco" name="numerobanco">
		        </form>	
      		</div>
	      	<div class="modal-footer">
...
@section('additionals_js')
    <script>
        ...
        var bancos_obtener = '{!!URL::to('bancos_obtener')!!}';
        var bancos_obtener_ultimo_numero = '{!!URL::to('bancos_obtener_ultimo_numero')!!}';
        var bancos_guardar = '{!!URL::to('bancos_guardar')!!}';
        var bancos_alta_o_baja = '{!!URL::to('bancos_alta_o_baja')!!}'; 
        var bancos_obtener_banco = '{!!URL::to('bancos_obtener_banco')!!}'; 
        var bancos_guardar_modificacion = '{!!URL::to('bancos_guardar_modificacion')!!}';
    </script>
    @include('secciones.libreriasregistrosycatalogos')
    <script src="scripts_inaasys/catalogos/bancos/bancos.js"></script>
@endsection