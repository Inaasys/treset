...
<html>
    <head>
        ...
        <title>Formato Cliente | Cotización Producto</title>
    </head>
    <style>
        .saltopagina {
            overflow: hidden;
                ...
                <div id ="contenedor" style="margin-top:10px;">
                    <div style="width:53.8%; height:110px; float:left; text-align: left; border-style: groove;">
                        <ul style="list-style:none;margin-left:-35px;margin-top:5px;">
                            <li style="font-size:10px; margin-left: 5px;"> Cliente: {{$d['cliente']->Nombre}} ({{$d['cotizacionproducto']->Cliente}})</li>
                            <li style="font-size:10px; margin-left: 5px;"> Agente: ({{$d['cotizacionproducto']->Agente}})</li>
                            <li style="font-size:10px; margin-left: 5px;"> Referencia: {{$d['cotizacionproducto']->Referencia}}</li>
                            <li style="font-size:10px; margin-left: 5px;"> Observaciones: {{$d['cotizacionproducto']->Obs}}</li>
                        </ul>
                    </div>
                    ...
                    <div style="width:45%; height:110px; float:left; text-align: left; border-style: groove;">
                        <ul style="list-style:none;margin-left:-35px;margin-top:5px;">
                            ...
                            <li style="font-size:10px; margin-left: 5px;">Fecha: {{$d['cotizacionproducto']->Fecha}}</li>
                            <li style="font-size:10px; margin-left: 5px;">Status: {{$d['cotizacionproducto']->Status}}</li>
                            <li style="font-size:10px; margin-left: 5px;">Tipo: {{$d['cotizacionproducto']->Tipo}}</li>
                        </ul>
                    </div>
                </div>
