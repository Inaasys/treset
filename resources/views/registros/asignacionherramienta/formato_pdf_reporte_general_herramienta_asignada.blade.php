            ...
            <section style="height:1200px">
                ...
                <div id ="contenedor">
                    <div style="width:100%; float:right; text-align: right;">
                        <p style="font-size:15px;">REPORTE GENERAL HERRAMIENTA ASIGNADA</p>
                    ...
                    <table style="width: 100%;max-width: 100%;border: 1px solid #ddd;">
                        <thead style="background-color:#a6a6b3; font-size:11px;">
                            <tr>
                                ...
                                <th>Herramienta</th>
                                <th>Descripción</th>
                                <th>Cantidad Inicial Asignación</th>
                        ...
                        <tbody style="background-color:#ddd; font-size:11px; text-align: center;">
                            ...
                            <tr>
                                ...
                                <td>{{$dd['cantidadinicialasignacion']}}</td>
                                <td>{{$dd['estadoauditoriadetalle']}}</td>
                                <td>{{$dd['cantidadauditoriadetalle']}}</td>
                                <td>{{$dd['preciodetalle']}}</td>
                                <td>{{$dd['totaldetalle']}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                ...
                <div id ="contenedor" style="margin-top:75px;">
                    <b>Herramienta Faltante</b>
                    <table style="width: 100%;max-width: 100%;border: 1px solid #ddd;">
                        <thead style="background-color:#a6a6b3; font-size:11px;">
                            <tr>
                                <th>Asignación</th>
                        ...
                        <tbody style="background-color:#ddd; font-size:11px; text-align: center;">
                            @foreach($data[0]['datadetallefaltante'] as $ddf)
                            <tr>
                                <td>{{$ddf['asignaciondetalle']}}</td>    
                                <td>{{$ddf['herramientadetalle']}}</td>
                                <td>{{$ddf['descripciondetalle']}}</td>
                                <td>{{$ddf['estadoauditoriadetalle']}}</td>
                                <td>{{$ddf['cantidadauditoriadetalle']}}</td>
                                <td>{{$ddf['preciodetalle']}}</td>
                                <td>{{$ddf['totaldetalle']}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <td style="font-size:12px;text-align: right;">Total $ : </td>
                                <td style="font-size:12px;text-align: right;"><b>{{$data[0]['totalfaltante']}}</b></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
                ...
                <div id ="contenedor">
                    <div style="width:99%;  float:left; text-align: left;">
                        <p style="text-align: justify;color: red; font-size:11px;">
                            DE ACUERDO A LA AUDITORÍA REALIZADA EN MI PRESENCIA, YO {{$data[0]['Personal_Recibe_Herramienta']->nombre}} AUTORIZO QUE LA HERRAMIENTA FALTANTE A MI CARGO SEA DESCONTADA VÍA NÓMINA POR UN MONTO TOTAL DE $ {{$data[0]['totalfaltante']}} PARA QUE SEA REPUESTA A LA EMPRESA {{$empresa->Empresa}}  
                        </p>
                    </div>
                </div>       
            </section>
