        ...
        <div class="saltopagina">
            <section>
                ...
                <div id ="contenedor" style="margin-top:10px;">
                    <div style="width:53%; height:125px;float:left;text-align:left;border-style:groove;">    
                    ...
                    <div style="width:45%; height:125px; float:left; text-align: left; border-style: groove;">
                        <ul style="list-style:none;margin-left:-35px;margin-top:5px;">
