            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formactualizartipocambio" action="#">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Valor tipo cambio cummins: {{$ultimo_valor_tipo_cambio_cummins}}</h4>
                            </div>
                            <div class="col-md-6">
                                <h4>Ultima actualización: {{$ultima_fecha_actualización_tipo_cambio_cummins}}</h4>
                            </div>
                            <div class="col-md-6">
...
@section('additionals_js')
    <script>
        ...
        var lista_precios_cummins_obtener = '{!!URL::to('lista_precios_cummins_obtener')!!}';
        var lista_precios_cummins_obtener_valor_dolar_hoy_dof = '{!!URL::to('lista_precios_cummins_obtener_valor_dolar_hoy_dof')!!}';
        var lista_precios_cummins_guardar_valor_tipo_cambio = '{!!URL::to('lista_precios_cummins_guardar_valor_tipo_cambio')!!}';
        var lista_precios_cummins_actualizar_lista_precios_vs_excel = '{!!URL::to('lista_precios_cummins_actualizar_lista_precios_vs_excel')!!}';
    </script>
    @include('secciones.libreriasregistrosycatalogos')
    <script src="scripts_inaasys/registros/listasprecios/cummins.js"></script>
@endsection