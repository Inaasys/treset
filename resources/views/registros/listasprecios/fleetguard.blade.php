                        ...
                        <div class="header {{$empresa->background_forms_and_modals}}">
                            <div class="row clearfix">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <h5>&nbsp;&nbsp;&nbsp;LISTA PRECIOS FLEETGUARD&nbsp;&nbsp;&nbsp;</h5>
                                </div>
...
@section('additionals_js')
    <script>
        ...
        var lista_precios_fleetguard_obtener = '{!!URL::to('lista_precios_fleetguard_obtener')!!}';
        var lista_precios_fleetguard_actualizar_lista_precios_vs_excel = '{!!URL::to('lista_precios_fleetguard_actualizar_lista_precios_vs_excel')!!}';
    </script>
    @include('secciones.libreriasregistrosycatalogos')
    <script src="scripts_inaasys/registros/listasprecios/fleetguard.js"></script>
@endsection