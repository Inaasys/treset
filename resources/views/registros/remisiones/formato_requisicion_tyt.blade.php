            ...
            <section style="width:93%;margin-left:30px;">
						...
						<tr>
							...
							<td  style="width:47%" style="float:right;">
								<table style="width: 100%;max-width: 100%;font-size:11px">
									<tr>
										<td style="font-size:8px;text-align:center;width:20%;"><p>{{$d['remision']->Referencia}}<p></td>
										<td style="font-size:8px;text-align:center;width:20%;"><p>{{$d['remision']->Os}}<p></td>
										<td style="font-size:8px;text-align:center;width:20%;"><p>{{$d['remision']->Eq}}<p></td>
                ...
                <div id ="contenedor" style="height:280px;">
                    ...
                    <div style="height:100%;width: 100%;">
                        <!--<hr><br><hr><br><hr><br><hr><br><hr><br><hr><br><hr><br><hr><br><hr><br><hr><br><hr><br><hr><br><hr><br><hr><br>-->
