                ...
                <div id ="contenedor" style="margin-top:10px;">
                    <div style="width:53%; height:110px; float:left; text-align: left; border-style: groove;">
                        <ul style="list-style:none;margin-left:-35px;margin-top:5px;">
                            <li style="font-size:10px; margin-left: 5px;"> Proveedor: {{$d['proveedor']->Nombre}}</li>
                            <li style="font-size:10px; margin-left: 5px;"> Calle: {{$d['proveedor']->Calle}}</li>
                            <li style="font-size:10px; margin-left: 5px;"> Colonia: {{$d['proveedor']->Colonia}}</li>
                            <li style="font-size:10px; margin-left: 5px;"> Municipio: {{$d['proveedor']->Municipio}}</li>
                        </ul>
                    </div>
                    ...
                    <div style="width:45%; height:110px; float:left; text-align: left; border-style: groove;">
                        <ul style="list-style:none;margin-left:-35px;margin-top:5px;">
                            ...
                            <li style="font-size:10px; margin-left: 5px;">Fecha: {{$d['notacreditoproveedor']->Fecha}}</li>
                            <li style="font-size:10px; margin-left: 5px;">Status: {{$d['notacreditoproveedor']->Status}}</li>
                        </ul>
                    </div>
                </div>
