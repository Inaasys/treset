                ...
                <div id ="contenedor" style="margin-top:10px;">
                    <div style="width:53%; height:110px; float:left; text-align: left; border-style: groove;">
                        <ul style="list-style:none;margin-left:-35px;margin-top:5px;">
                            <li style="font-size:10px; margin-left: 5px;"> Del Almacén: {{$d['almacende']->Nombre}} ({{$d['almacende']->Numero}})</li>
                            <li style="font-size:10px; margin-left: 5px;"> Al Almacén: {{$d['almacena']}}</li>
                            <li style="font-size:10px; margin-left: 5px;"> Referencia: {{$d['traspaso']->Referencia}}</li>
                            <li style="font-size:10px; margin-left: 5px;"> Observaciones: {{$d['traspaso']->Obs}}</li>
                        </ul>
                    </div>
                    ...
                    <div style="width:45%; height:110px; float:left; text-align: left; border-style: groove;">
                        <ul style="list-style:none;margin-left:-35px;margin-top:5px;">
                            <li style="font-size:18px; margin-left: 5px;"><b>Traspaso: </b><b style="color:red">{{$d['traspaso']->Traspaso}}</b></li>
                            <li style="font-size:10px; margin-left: 5px;">Fecha: {{$d['traspaso']->Fecha}}</li>
                            <li style="font-size:10px; margin-left: 5px;">Status: {{$d['traspaso']->Status}}</li>
                            <li style="font-size:10px; margin-left: 5px;">Orden: {{$d['traspaso']->Orden}}</li>
                        </ul>
                    </div>
                </div>
