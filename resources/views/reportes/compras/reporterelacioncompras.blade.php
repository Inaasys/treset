                    ...
                    <div class="card" id="listadoregistros">
                        <div class="header {{$empresa->background_forms_and_modals}} table-responsive button-demo">
                        	<table>
                        		<tr>
                        			<td >
                        				<h5>&nbsp;&nbsp;&nbsp;Reporte Relación Compras&nbsp;&nbsp;&nbsp;</h5>
                        			</td>
                                    <td >
                            ...
                            <form id="formreporte">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                        ...
                                        <select class="form-control select2" name="movimiento" id="movimiento" onchange="generar_reporte()"  required>
...
@section('additionals_js')
    <script>
        ...
        var reporte_relacion_compras_obtener_tipos_ordenes_compra = '{!!URL::to('reporte_relacion_compras_obtener_tipos_ordenes_compra')!!}';
        var reporte_relacion_compras_obtener_proveedores = '{!!URL::to('reporte_relacion_compras_obtener_proveedores')!!}';
        var reporte_relacion_compras_obtener_almacenes = '{!!URL::to('reporte_relacion_compras_obtener_almacenes')!!}';
        var reporte_relacion_compras_obtener_proveedor_por_numero = '{!!URL::to('reporte_relacion_compras_obtener_proveedor_por_numero')!!}';
        var reporte_relacion_compras_obtener_almacen_por_numero = '{!!URL::to('reporte_relacion_compras_obtener_almacen_por_numero')!!}';
        var reporte_relacion_compras_generar_reporte = '{!!URL::to('reporte_relacion_compras_generar_reporte')!!}';
    </script>
    @include('secciones.libreriasregistrosycatalogos')
    <script src="scripts_inaasys/reportes/compras/reporterelacioncompras.js"></script>
@endsection