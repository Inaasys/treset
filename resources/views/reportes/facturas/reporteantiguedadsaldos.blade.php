                    ...
                    <div class="card" id="listadoregistros">
                        <div class="header bg-red table-responsive button-demo">
                        	<table>
                        		<tr>
                        			<td >
                        				<h5>&nbsp;&nbsp;&nbsp;Reporte Antiguedad Saldos&nbsp;&nbsp;&nbsp;</h5>
                        			</td>
                                    <td >
                        ...
                        <div class="body">
                            <form id="formreporte">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                        <label>Saldo mayor a cero</label>
                                        <div class="col-md-12 form-check">
                                            <input type="checkbox" name="saldomayor" id="idsaldomayor" class="filled-in" value="1" onchange="generar_reporte()"  checked/>
                                            <label for="idsaldomayor">Saldo mayor a cero</label>
                                        </div>
                                    </div> 
                                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                        <label>Reporte</label>
...
@section('additionals_js')
    <script>
        ...
        var reporte_antiguedad_saldos_obtener_clientes = '{!!URL::to('reporte_antiguedad_saldos_obtener_clientes')!!}';
        var reporte_antiguedad_saldos_obtener_series = '{!!URL::to('reporte_antiguedad_saldos_obtener_series')!!}';
        var reporte_antiguedad_saldos_obtener_cliente_por_numero = '{!!URL::to('reporte_antiguedad_saldos_obtener_cliente_por_numero')!!}';
        var reporte_antiguedad_saldos_obtener_serie_por_clave = '{!!URL::to('reporte_antiguedad_saldos_obtener_serie_por_clave')!!}';
        var reporte_antiguedad_saldos_generar_reporte = '{!!URL::to('reporte_antiguedad_saldos_generar_reporte')!!}';
    </script>
    @include('secciones.libreriasregistrosycatalogos')
    <script src="scripts_inaasys/reportes/facturas/reporteantiguedadsaldos.js"></script>
@endsection