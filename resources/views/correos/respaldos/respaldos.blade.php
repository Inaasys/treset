            ...
            <td align="center" valign="top">
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%" bgcolor="#4dbfbf">
                  <tr>
                    <td>
                    <br>
                      <img src="{{ $message->embed(public_path() . '/images/correos/icono6.png') }}" width="180" height="159" alt="robot picture">
                    </td>
                  </tr>
                  <tr>
                    <td class="headline">
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%" bgcolor="#f5774e">
                  <tr>
                    <td>
                    <br>
                      <img src="{{ $message->embed(public_path() . '/images/correos/icono10.png') }}" width="113" height="100" alt="meter image">
                    </td>
                  </tr>
                  <tr>
                    <td>
                        ...
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                          <tr>
                            <td style="color:#933f24;">
                              Se realizo una nueva copia de seguridad de la base de datos,<br> Si desconfia de la fuenta <a style="color:#ffffff" href="#">contacte a soporte técnico</a> <br><br>
                              </td>
                            </tr>
                            <tr>
                              <td style="color:#933f24;">
