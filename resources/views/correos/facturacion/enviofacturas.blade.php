                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="logo" style="text-align: center;">
                                    <img src="{{ $message->embed(public_path() . '/logotipo_empresa/logoempresacorreos.jpg') }}" width="25%" height="25%">
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="text-align: left; padding-right: 10px;">
                                                <h3 class="heading">Visítanos</h3>
                                                <p>Dirección: {{$calleempresa}}, {{$noexteriorempresa}}, {{$coloniaempresa}}, {{$cpempresa}}, {{$municipioempresa}}, {{$estadoempresa}} </p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <tr>
                    <td class="bg_white" style="text-align: center;">
                        <p><a href="#" style="color: rgba(0,0,0,.8);">Inaasys 2022 Copyright® Todos los derechos reservados. </a></p>
                    </td>
                </tr>
            </table>
        </div>
