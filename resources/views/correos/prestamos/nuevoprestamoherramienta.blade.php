                    ...
                    <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="600" class="w320">
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <tr>
                                    <td>
                                        <br><img src="{{ $message->embed(public_path() . '/images/correos/icono6.png') }}" width="113" height="100" alt="meter image"><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                                ...
                                                <tbody>
                                                    @foreach($filascorreo as $fc)
                                                        <tr>
                                                            ...
                                                            <td>{{$fc['descripcionpartida']}}</td>
                                                            <td>{{$fc['cantidadpartida']}}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
