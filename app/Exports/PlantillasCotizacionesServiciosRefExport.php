...
class PlantillasCotizacionesServiciosRefExport implements FromCollection,WithHeadings,WithTitle,WithColumnWidths
{
    /**
    ...
    */
    ...
    public function title(): string{
        return 'plantillacotizacionserviciosref';
    }
