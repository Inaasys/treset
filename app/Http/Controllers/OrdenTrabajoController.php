...
class OrdenTrabajoController extends ConfiguracionSistemaController
{
                ...
                //}else{
                    ...
                    if($contarservicios > 0){
                        ...
                        '<tr class="filasservicios" id="filaservicio'.$contadorservicios.'">'.
                            ...
                            '<td class="tdmod"><input type="number" step="0.'.$this->numerocerosconfiguradosinputnumberstep.'" class="form-control inputnextdet divorinputmodsm comisionporcentajepartida" name="comisionporcentajepartida[]" value="'.Helpers::convertirvalorcorrecto($comisionporcentajepartidaservicio).'" data-parsley-decimalesconfigurados="/^[0-9]+[.]+[0-9]{'.$this->numerodecimales.'}$/" onchange="formatocorrectoinputcantidades(this)" readonly></td>'.
                            ...
                            '<td class="tdmod"><input type="hidden" class="form-control divorinputmodl numerotecnicopartida1" name="numerotecnicopartida1[]" value="0" readonly><input type="text" class="form-control divorinputmodl tecnicopartida1" name="tecnicopartida1[]" value="0" readonly data-parsley-tecnico="[3, 1000]"></td>'.
        ...
        if($numerodetallescotizacion > 0){
            ...
            foreach($detallescotizacion as $dc){
                ...
                '<tr class="filasservicios" id="filaservicio'.$contadorservicios.'">'.
                    ...
                    '<td class="tdmod"><input type="text" class="form-control divorinputmodxs comprapartida" name="comprapartida[]" readonly data-parsley-length="[1, 20]"></td>'.
                    '<td class="tdmod"><input type="text" class="form-control divorinputmodxs usuariopartida" name="usuariopartida[]" value="'.Auth::user()->user.'" readonly></td>'.
                    '<td class="tdmod"><input type="text" class="form-control inputnextdet divorinputmodxl anotacionespartida" name="anotacionespartida[]" data-parsley-length="[1, 255]"></td>'.
                    '<td class="tdmod"><input type="text" class="form-control divorinputmodxs statuspartida" name="statuspartida[]" readonly></td>'.
    ...
    public function ordenes_trabajo_obtener_orden_trabajo(Request $request){
        ...
        //$partida = 1;
        //partida
        $ultimapartida = OrdenTrabajoDetalle::select("Partida")->where('Orden', $request->ordenmodificar)->orderBy("Partida", "DESC")->take(1)->get();
        ...
        if($numerodetallesordentrabajo > 0){
            foreach($detallesordentrabajo as $dot){
                ...
                '<tr class="filasservicios" id="filaservicio'.$contadorservicios.'">'.
                    ...
                    '<td class="tdmod"><input type="number" step="0.'.$this->numerocerosconfiguradosinputnumberstep.'" class="form-control inputnextdet divorinputmodsm descuentoporcentajepartida" name="descuentoporcentajepartida[]" value="'.Helpers::convertirvalorcorrecto($dot->Dcto).'" data-parsley-decimalesconfigurados="/^[0-9]+[.]+[0-9]{'.$this->numerodecimales.'}$/" onchange="formatocorrectoinputcantidades(this);calculardescuentopesospartida('.$contadorfilas.');" '.$readonly.'></td>'.
                    ...
                    '<td class="tdmod"><input type="number" step="0.'.$this->numerocerosconfiguradosinputnumberstep.'" class="form-control inputnextdet divorinputmodsm ivaporcentajepartida" name="ivaporcentajepartida[]" value="'.Helpers::convertirvalorcorrecto($dot->Impuesto).'" data-parsley-decimalesconfigurados="/^[0-9]+[.]+[0-9]{'.$this->numerodecimales.'}$/" onchange="formatocorrectoinputcantidades(this);calculartotalesfilasordentrabajo('.$contadorfilas.');" readonly></td>'.
                    ...
                    '<td class="tdmod"><input type="number" step="0.'.$this->numerocerosconfiguradosinputnumberstep.'" class="form-control inputnextdet divorinputmodsm comisionporcentajepartida" name="comisionporcentajepartida[]" value="'.Helpers::convertirvalorcorrecto($dot->Com).'" data-parsley-decimalesconfigurados="/^[0-9]+[.]+[0-9]{'.$this->numerodecimales.'}$/" onchange="formatocorrectoinputcantidades(this)" readonly></td>'.
                    ...
                    '<td class="tdmod"><input type="text" class="form-control inputnextdet divorinputmodxl anotacionespartida" name="anotacionespartida[]" value="'.$dot->Anotaciones.'" '.$readonly.'  data-parsley-length="[1, 255]"></td>'.
                    ...
                    '<td class="tdmod"><input type="text" class="form-control inputnextdet divorinputmodxs promocionpartida" name="promocionpartida[]" value="'.$dot->Promocion.'" readonly></td>'.
        ...
        if($request->imprimirdirectamente == 1){
            ...
            if($tipogeneracionpdf == 0){
                ...
                if ($request->has("seriesdisponiblesdocumento")){
                    $ordenestrabajo = OrdenTrabajo::whereBetween('Fecha', [$fechainiciopdf, $fechaterminacionpdf])->whereIn('Serie', $request->seriesdisponiblesdocumento)->orderBy('Folio', 'ASC')->take(500)->get();
                }else{
