...
class NotasCreditoProveedoresController extends ConfiguracionSistemaController{
    ...
    public function notas_credito_proveedores_obtener(Request $request){
        if($request->ajax()){
            ...
            $data = VistaNotaCreditoProveedor::select($this->campos_consulta)->where('Periodo', $periodo);
            ...
            foreach($detallesnotaproveedor as $dnp){
                    ...
                    if($dnp->Codigo == 'DPPP'){
                        ...
                        '<tr class="filasproductos" id="filaproducto'.$contadorfilas.'">'.
                            ...
                            '<td class="tdmod"><input type="text" class="form-control divorinputmodl descripcionpartida" name="descripcionpartida[]" value="'.htmlspecialchars($dnp->Descripcion, ENT_QUOTES).'" required data-parsley-length="[1, 255]" onkeyup="tipoLetra(this)"></td>'.
