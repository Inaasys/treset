        ...
        if($numerodetallesordencompra > 0){
            ...
            foreach($detallesordencompra as $doc){
                ...
                '<tr class="filasproductos filaproducto'.$contadorproductos.'" id="filaproducto'.$contadorproductos.'">'.
                    ...
                    '<td class="tdmod">'.
                        '<input type="text" class="form-control inputnextdet divorinputmodsm preciopartidaAux"  name="preciopartidaAux[]" value="'.number_format(Helpers::convertirvalorcorrecto($doc->Precio),$this->numerodecimales,'.',',').'" onchange="calculartotalesfilasordencompra('.$contadorfilas.');cambiodecantidadopreciopartida('.$contadorfilas.',\''.$tipo .'\');formatocorrectoinputcantidadesComma(this);">'.
                        '<input type="number" style="display:none;" step="0.'.$this->numerocerosconfiguradosinputnumberstep.'" class="form-control inputnextdet divorinputmodsm preciopartida"  name="preciopartida[]" value="'.Helpers::convertirvalorcorrecto($doc->Precio).'" data-parsley-decimalesconfigurados="/^[0-9]+[.]+[0-9]{'.$this->numerodecimales.'}$/" onchange="calculartotalesfilasordencompra('.$contadorfilas.');cambiodecantidadopreciopartida('.$contadorfilas.',\''.$tipo .'\');formatocorrectoinputcantidades(this);">'.
                    '</td>'.
                    '<td class="tdmod">'.
                    ...
                    '<td class="tdmod">'.
                        '<input type="text" class="form-control inputnextdet divorinputmodsm descuentopesospartidaAux"  name="descuentopesospartidaAux[]" value="'.number_format(Helpers::convertirvalorcorrecto($doc->Descuento),$this->numerodecimales,'.',',').'" onchange="calculardescuentoporcentajepartida('.$contadorfilas.');formatocorrectoinputcantidadesComma(this);" >'.
                    ...
                    '<td class="tdmod">'.
                        '<input type="text" class="form-control divorinputmodsm ivapesospartidaAux"  name="ivapesospartidaAux[]" value="'.number_format(Helpers::convertirvalorcorrecto($doc->Iva),$this->numerodecimales,'.',',').'" readonly>'.
                        '<input type="number" style="display:none;" step="0.'.$this->numerocerosconfiguradosinputnumberstep.'" class="form-control divorinputmodsm ivapesospartida"  name="ivapesospartida[]" value="'.Helpers::convertirvalorcorrecto($doc->Iva).'" data-parsley-decimalesconfigurados="/^[0-9]+[.]+[0-9]{'.$this->numerodecimales.'}$/" readonly>'.
                    '</td>'.
                    '<td class="tdmod">'.
