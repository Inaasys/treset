        ...
        if($Numero_Prestamo_Herramienta_Detalle > 0){
            ...
            foreach($Prestamo_Herramienta_Detalle as $phd){
                ...
                '<tr class="filasproductos" id="filaproducto'.$contadorproductos.'">'.
                            ...
                            '<td class="tdmod"><input type="number" step="0.'.$this->numerocerosconfiguradosinputnumberstep.'" class="form-control inputnextdet divorinputmodsm preciopartida" name="preciopartida[]" value="'.$phd->precio.'" onchange="formatocorrectoinputcantidades(this);" required readonly></td>'.
