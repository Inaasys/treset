        ...
        if($numerodetallescotizacion > 0){
            ...
            foreach($detallescotizacion as $dc){
                ...
                '<tr class="filasproductos" id="filaproducto'.$contadorproductos.'">'.
                    ...
                    '<td class="tdmod"><input type="hidden" class="form-control codigopartida" name="codigopartida[]" value="'.$dc->numero_parte.'" readonly data-parsley-length="[1, 50]"><b style="font-size:12px;">'.$dc->numero_parte.'</b></td>'.
