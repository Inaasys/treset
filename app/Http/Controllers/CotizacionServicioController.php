        ...
        if($numerodetallesservicioscotizacion > 0){
            ...
            foreach($detallesservicioscotizacion as $dsc){
                ...
                '<tr class="filasservicios" id="filaservicio'.$contadorservicios.'">'.
                    ...
                    '<td class="tdmod"><input type="number" step="0.'.$this->numerocerosconfiguradosinputnumberstep.'" class="form-control divorinputmodsm utilidadpartidaservicio" name="utilidadpartidaservicio[]" value="'.Helpers::convertirvalorcorrecto($dsc->Utilidad).'" data-parsley-decimalesconfigurados="/^[0-9]+[.]+[0-9]{'.$this->numerodecimales.'}$/" onchange="formatocorrectoinputcantidades(this);" readonly></td>'.
                '</tr>';
