...
function obtenerclientes(){
    ...
    var tablaclientes = '<div class="modal-header '+background_forms_and_modals+'">'+
        ...
        $('#tbllistadocliente').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: reporte_facturas_vencidas_obtener_clientes
            },
            columns: [
...
function obtenerseries(){ 
    ...
    $('#tbllistadoserie').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: reporte_facturas_vencidas_obtener_series,
        },
        columns: [
            { data: 'operaciones', name: 'operaciones', orderable: false, searchable: false },
...
function obtenerclientepornumero(){
    ...
    if(numeroclienteanterior != numerocliente){
        if($("#numerocliente").parsley().isValid()){
            $.get(reporte_facturas_vencidas_obtener_cliente_por_numero, {numerocliente:numerocliente}, function(data){
...
function obtenerserieporclave(){
    ...
    if(claveserieanterior != claveserie){
        if($("#claveserie").parsley().isValid()){
            $.get(reporte_facturas_vencidas_obtener_serie_por_clave, {claveserie:claveserie}, function(data){
...
function generar_formato_excel(){
    ...
    if (form.parsley().isValid()){
        ...
        $("#btnGenerarFormatoReporteExcel").attr("href", urlgenerarformatoexcel+'?fechacorte='+fechacorte+'&numerocliente='+numerocliente+'&claveserie='+claveserie+'&departamento='+departamento+'&reporte='+reporte);
...
function generar_formato_pdf(){
    ...
    if (form.parsley().isValid()){
        ...
        var departamento = $("#departamento").val();
        var reporte = $("#reporte").val();
        $("#btnGenerarFormatoReportePdf").attr("href", urlgenerarformatopdf+'?fechacorte='+fechacorte+'&numerocliente='+numerocliente+'&claveserie='+claveserie+'&departamento='+departamento+'&reporte='+reporte);
...
function listar(){
    ...
    switch(reporte){
        case "GENERAL":
            var columnas = new Array("Factura", "Serie", "Folio", "Esquema", "Status", "NombreCliente", "Fecha", "Depto", "FormaPago", "SubTotal", "Iva", "Total", "Abonos", "Descuentos", "Saldo");
            break;
        case "DETALLES":
    ...
    tabla=$('#tbllistado').DataTable({
        ...
        ajax: {
            ...
            url: reporte_facturas_vencidas_generar_reporte,
            method: 'POST',
            data: function (d) {
