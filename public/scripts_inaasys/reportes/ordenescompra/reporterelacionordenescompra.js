...
function obtenertiposordenescompra(){
    $.get(reporte_relacion_ordenes_compra_obtener_tipos_ordenes_compra, function(select_tipos_ordenes_compra){
...
function obtenerproveedores(){
    ...
    $('#tbllistadoproveedor').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: reporte_relacion_ordenes_compra_obtener_proveedores,
        },
        columns: [
...
function obteneralmacenes(){ 
    ...
    $('#tbllistadoalmacen').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: reporte_relacion_ordenes_compra_obtener_almacenes,
        },
        columns: [
            { data: 'operaciones', name: 'operaciones', orderable: false, searchable: false },
            { data: 'Numero', name: 'Numero' },
...
function obtenerproveedorpornumero(){
    ...
    if(numeroproveedoranterior != numeroproveedor){
        if($("#numeroproveedor").parsley().isValid()){
            $.get(reporte_relacion_ordenes_compra_obtener_proveedor_por_numero, {numeroproveedor:numeroproveedor}, function(data){
...
function obteneralmacenpornumero(){
    ...
    if(numeroalmacenanterior != numeroalmacen){
        if($("#numeroalmacen").parsley().isValid()){
            $.get(reporte_relacion_ordenes_compra_obtener_almacen_por_numero, {numeroalmacen:numeroalmacen}, function(data){
...
function listar(){
    ...
    tabla=$('#tbllistado').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: reporte_relacion_ordenes_compra_generar_reporte,
            data: function (d) {
