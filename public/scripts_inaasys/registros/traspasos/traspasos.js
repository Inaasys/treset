                        ...
                        '<div class="row">'+
                            '<div class="col-md-6">'+
                                '<div class="col-md-12 form-check">'+
                                    '<label>DATOS TRASPASO</label>'+
                                '</div>'+
                                '<div class="col-md-4 form-check">'+
                                    '<input type="checkbox" name="Traspaso" id="idTraspaso" class="filled-in datotabla" value="Traspaso" readonly onchange="construirarraydatostabla(this);" onclick="javascript: return false;"/>'+
                                    '<label for="idTraspaso">Traspaso</label>'+
                                '</div>'+
                                '<div class="col-md-4 form-check">'+
                                ...
                                '</div>'+
                                '<div class="col-md-4 form-check">'+
                                    '<input type="checkbox" name="De" id="idDe" class="filled-in datotabla" value="De" onchange="construirarraydatostabla(this);" />'+
                                    '<label for="idDe">De</label>'+
                                '</div>'+
                                '<div class="col-md-4 form-check">'+
                                    '<input type="checkbox" name="A" id="idA" class="filled-in datotabla" value="A" onchange="construirarraydatostabla(this);" />'+
                                    '<label for="idA">A</label>'+
                                '</div>'+
                                '<div class="col-md-4 form-check">'+
                            ...
                            '<div class="col-md-6">'+
                                '<div class="col-md-12 form-check">'+
                                    '<label>DATOS ALMACÉN DE</label>'+
                                '</div>'+
                                '<div class="col-md-4 form-check">'+  
                                    '<input type="checkbox" name="NombreDe" id="idNombreDe" class="filled-in datotabla" value="NombreDe"  onchange="construirarraydatostabla(this);"/>'+
                                    '<label for="idNombreDe">NombreDe</label>'+ 
                                '</div>'+
                                '<div class="col-md-12 form-check">'+
                                    '<label>DATOS ALMACÉN A</label>'+
                                '</div>'+
                                '<div class="col-md-4 form-check">'+  
                                    '<input type="checkbox" name="NombreA" id="idNombreA" class="filled-in datotabla" value="NombreA"  onchange="construirarraydatostabla(this);"/>'+
                                    '<label for="idNombreA">NombreA</label>'+ 
                                '</div>'+
                                '<div class="col-md-12 form-check">'+
                                    '<label>DATOS ORDEN</label>'+
                                '</div>'+
                                '<div class="col-md-4 form-check">'+  
                                    '<input type="checkbox" name="StatusOrden" id="idStatusOrden" class="filled-in datotabla" value="StatusOrden"  onchange="construirarraydatostabla(this);"/>'+
                                    '<label for="idStatusOrden">StatusOrden</label>'+ 
                                '</div>'+
                                '<div class="col-md-4 form-check">'+  
