...
function listar(){
    tabla=$('#tbllistado').DataTable({
        ...
        columns: [
            ...
            { data: 'Caso', name: 'Caso', orderable: false, searchable: false },
            ...
            { data: 'Vin', name: 'Vin', orderable: false, searchable: false  },
            { data: 'Periodo', name: 'Periodo', orderable: false, searchable: false  },
            { data: 'Marca', name: 'Marca', orderable: false, searchable: false  },
            { data: 'Economico', name: 'Economico', orderable: false, searchable: false  },
            { data: 'Placas', name: 'Placas', orderable: false, searchable: false  },
            { data: 'Año', name: 'Año', orderable: false, searchable: false  },
            { data: 'Kilometros', name: 'Kilometros', orderable: false, searchable: false  },
            { data: 'Reclamo', name: 'Reclamo', orderable: false, searchable: false  },
