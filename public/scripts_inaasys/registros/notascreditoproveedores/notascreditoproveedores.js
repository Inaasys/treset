                      ...
                      '<div class="row">'+
                          '<div class="col-md-6">'+
                              '<div class="col-md-12 form-check">'+
                                  '<label>DATOS NOTA CRÉDITO PROVEEDOR</label>'+
                              '</div>'+
                              '<div class="col-md-4 form-check">'+
                                  '<input type="checkbox" name="Nota" id="idNota" class="filled-in datotabla" value="Nota" readonly onchange="construirarraydatostabla(this);" />'+
                              ...
                              '</div>'+
                              '<div class="col-md-4 form-check">'+
                                  '<input type="checkbox" name="NotaProveedor" id="idNotaProveedor" class="filled-in datotabla" value="NotaProveedor" onchange="construirarraydatostabla(this);" />'+
                                  '<label for="idNotaProveedor">NotaProveedor</label>'+
                              '</div>'+
                              '<div class="col-md-4 form-check">'+
