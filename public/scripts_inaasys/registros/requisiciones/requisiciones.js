...
function listarproductos(){
    ...
    $('#tbllistadoproducto tbody').on('dblclick', 'tr', function () {
        ...
        agregarfilaproducto(data.Codigo, data.Producto, data.Unidad, data.Costo, number_format(round(data.Impuesto, numerodecimales), numerodecimales, '.', ''), data.SubTotal, data.Existencias, tipooperacion, number_format(round(data.CostoDeLista, numerodecimales), numerodecimales, '.', ''));
    });
}
...
function agregarfilaproducto(Codigo, Producto, Unidad, Costo, Impuesto, SubTotal, Existencias, CostoDeLista, tipooperacion){
    ...
    if(result == false){
        ...
        var fila=   '<tr class="filasproductos" id="filaproducto'+contadorproductos+'">'+
                          ...
                          '<td class="tdmod"><input type="number" step="0.'+numerocerosconfiguradosinputnumberstep+'" class="form-control inputnextdet divorinputmodsm comisionporcentajepartida" name="comisionporcentajepartida[]" value="'+number_format(round(comisionporcentaje, numerodecimales), numerodecimales, '.', '')+'" data-parsley-decimalesconfigurados="/^[0-9]+[.]+[0-9]{'+numerodecimales+'}$/" onchange="formatocorrectoinputcantidades(this);" readonly></td>'+
    ...
    var tabs ='<div class="col-md-12">'+
                ...
                '<div class="row">'+
                  '<div class="col-md-3">'+
                    ...
                    '<table class="col-md-12">'+
                      '<tr>'+
                        ...
                        '<td>'+
                          '<div class="form-line">'+
                            '<input type="text" class="form-control inputnextdet" name="orden" id="orden" onkeyup="tipoLetra(this);" autocomplete="off" >'+
                  ...
                  '<div class="col-md-2">'+
                    ...
                    '<input type="text" class="form-control inputnextdet" name="statusorden" id="statusorden"  required readonly onkeyup="tipoLetra(this);" autocomplete="off">'+
                  '</div>'+
                  '<div class="col-md-2">'+
                    '<label>Cliente </label>'+
...
function enviardocumentoemail(documento){
  $.get(requisiciones_obtener_datos_envio_email,{documento:documento}, function(data){
    ...
    $("#emailmensaje").val("REQUISICION NO. " + documento +" DE "+ nombreempresa);
