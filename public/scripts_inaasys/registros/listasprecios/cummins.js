...
function listar(){
    ...
    tabla=$('#tbllistado').DataTable({
        ...
        serverSide: true,
        ajax: lista_precios_cummins_obtener,
...
$("#btnenviarpartidasexcel").on('click', function(e){
    ...
    $.ajax({
      ...
      url:lista_precios_cummins_actualizar_lista_precios_vs_excel,
      data: form_data,
      type: 'POST',
      contentType: false,
      processData: false,
...
function obtenervalordolarhoydof(){ 
    $('.page-loader-wrapper').css('display', 'block');
    $.get(lista_precios_cummins_obtener_valor_dolar_hoy_dof, function(valordolar){
...
$("#btnguardartipodecambio").on('click', function (e) {
    ...
    if (form.parsley().isValid()){
        ...
        $.ajax({
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            url:lista_precios_cummins_guardar_valor_tipo_cambio,
            type: "post",
            dataType: "html",
            data: formData,
            cache: false,
