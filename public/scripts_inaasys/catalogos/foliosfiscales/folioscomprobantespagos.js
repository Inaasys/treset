...
function obtenerdatos(numerofolio){
    ...
    $("#esquema").val(data.FolioComprobantePago.Esquema).change();
    $("#titulo").val(data.FolioComprobantePago.Titulo);
    $("#contrasenallaveprivada").val(data.FolioComprobantePago.Contraseña);
    $("#numerocertificado").val(data.FolioComprobantePago.NoCertificado);
    $("#certificadovalidodesde").val(data.FolioComprobantePago.ValidoDesde);
    $("#certificadovalidohasta").val(data.FolioComprobantePago.ValidoHasta);
    ...
    $("#pagare").val(data.FolioComprobantePago.Pagare);
    $("#ubicarlogotipo").val(data.FolioComprobantePago.UbicarLogotipo).change();
    $("#alinearlogotipo").val(data.FolioComprobantePago.AlinearLogotipo).change();
    $("#alinearempresa").val(data.FolioComprobantePago.AlinearEmpresa).change();
    if(data.FolioComprobantePago.ImprimirLogotipo == 'S'){
