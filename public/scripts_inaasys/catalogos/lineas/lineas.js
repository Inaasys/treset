...
function obtenultimonumero(){
  $.get(lineas_obtener_ultimo_numero, function(numero){
    $("#numero").val(numero);
  })  
}
//cerrar modales
...
function desactivar(numerolinea){
  $("#numerolinea").val(numerolinea);
...
function obtenerdatos(numerolinea){
  $("#titulomodal").html('Modificación Linea');
  $('.page-loader-wrapper').css('display', 'block');
  $.get(lineas_obtener_linea,{numerolinea:numerolinea },function(data){
...
$("#btnGuardarModificacion").on('click', function (e) {
  ...
  if (form.parsley().isValid()){
    ...
    $.ajax({
      headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
      url:lineas_guardar_modificacion,
      type: "post",
      dataType: "html",
      data: formData,
      cache: false,
